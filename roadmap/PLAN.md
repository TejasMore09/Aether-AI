...
Phase 0 complete. Phase 1 started 2026-08-28. **1.1–1.4 done; next is 1.5.**
232 tests, none skipped.
...
- [ ] **1.7** Dashboard surface for cross-domain findings, visibly distinct from per-domain ones
