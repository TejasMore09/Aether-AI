...
>
> **6.1 and 6.2 are done**: the platform comes up as ten containers from one
> compose file behind a Caddy edge that holds its own certificates, refuses to
> start on a development configuration, and backs itself up nightly — each
> backup restored into a scratch database and questioned before it counts as
...
>
> **6.6 is done**: TOTP with encrypted secrets, recovery codes and replay
